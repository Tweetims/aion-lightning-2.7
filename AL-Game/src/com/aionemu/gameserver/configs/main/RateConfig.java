...
public class RateConfig {
	...
	/**
	 * Option slots on items will always be maximum
	 */
	@Property(key = "gameserver.rate.option.slot.always", defaultValue = "false")
	public static boolean OPTION_SLOT_ALWAYS;
}
